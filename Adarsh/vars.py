...
class Var(object):
    ...
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'DAEMON'))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://8te25tx:wm1YWWL7E9hSK25g@cluster0.nom13o1.mongodb.net/?retryWrites=true&w=majority'))
